...
export default function Palette({ initialHexes }: { initialHexes: string[] }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <p className="font-light text-neutral-500 select-none mb-3">
      ...
      <div className="flex flex-col justify-center items-center my-20 gap-3">
        <Button
          className="cursor-pointer rounded-none w-64 h-12 gap-4 text-lg font-normal"
          size="lg"
          aria-label="Generate"
        ...
        <p className="font-light text-neutral-500 select-none">
